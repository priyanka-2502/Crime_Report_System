...
<body style="background-size:repeat;
  ...
  <div class="container">
    ...
    <div class="menu">
      ...
      <a href="userlogin.php"><i class="fa fa-home"></i>user login</a>
          
             <a href="complainer_complain_history.php"><i class="fa fa-users"></i>complaint history</a> 
