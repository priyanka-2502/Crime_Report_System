...
session_start();
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        $cid=$_POST['cid'];
        $_SESSION['cid']=$cid;
        header("location:head_casedetails.php");
    }
    }
...
<body style="background-image: url(mhq.jpg);background-size:cover;
...
<nav>
         ...
         <div class="container">
           ...
           <a href="home.html"><i class="fa fa-home"></i> official login</a> 
             <a href="#"><i class="fa fa-user"></i>HQ home</a> 
             <a href="#"><i class="fa fa-file"></i>view Complaint</a> 
             <a href="headview_policestation.php"><i class="fa fa-users"></i>police station</a> 
