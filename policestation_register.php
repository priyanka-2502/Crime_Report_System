...
<body style="background-image: url(gun.jpg);background-size:cover;
background-position: center;">
<nav>
          <div class="logo"><b>crime portal</b></div>
         <div class="container">
           <div class="menu">
           <a href="official_login..html"><i class="fa fa-home"></i> official login</a> 
             <a href="headhome.php"><i class="fa fa-user"></i>HQ home</a> 
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
      ...
      <form  method="post" style="color: black">Police Station Location
