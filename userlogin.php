...
<body style="background-image: url(user.jpg);background-size: 100%;background-repeat: no-repeat;">
	<nav>
  <div class="container">
    <div class="navbar-header">
     
      <div class="logo" href="home.html" ><b>Crime Portal</b></div>
    </div>
    <div class="menu">
    <a href="home.html"><i class="fa fa-home"></i>home</a>
             <a href="user_login.php"><i class="fa fa-user"></i> user login</a> 
